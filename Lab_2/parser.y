...
%{
  ...
  for the location of tokens */
    ...
    */
    ...
    %type <expressions> expr_params_list
    %type <expressions> expr_params
    ...
    */
    ...
    { $$ = assign($1,$3); }
    | expr '.' OBJECTID '(' expr_params_list ')'
    { $$ = dispatch($1,$3,$5); }
    | expr '@' TYPEID '.' OBJECTID '(' expr_params_list ')'
    { $$ = static_dispatch($1,$3,$5,$7); }
    | OBJECTID '(' expr_params_list ')'
